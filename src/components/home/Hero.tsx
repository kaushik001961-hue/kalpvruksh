...
export default function Hero() {
  return (
    <section className="relative overflow-hidden">
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="p-6 sm:p-8 text-center border-b sm:border-r border-neutral-100">
              <h2 className="text-4xl sm:text-5xl font-bold text-emerald-600">
                5000+
              </h2>
              <p className="mt-2 sm:mt-3 text-neutral-600 font-medium text-sm sm:text-base">
                Lives Impacted
              </p>
            </div>

            <div className="p-6 sm:p-8 text-center border-b sm:border-b-0 lg:border-r border-neutral-100">
              <h2 className="text-4xl sm:text-5xl font-bold text-emerald-600">
                200+
              </h2>
              <p className="mt-2 sm:mt-3 text-neutral-600 font-medium text-sm sm:text-base">
            ...
            <div className="p-6 sm:p-8 text-center border-b sm:border-b-0 sm:border-r border-neutral-100">
              <h2 className="text-4xl sm:text-5xl font-bold text-emerald-600">
                150+
              </h2>
              <p className="mt-2 sm:mt-3 text-neutral-600 font-medium text-sm sm:text-base">
      ...
      ========================= */}
      <div className="mx-auto mt-20 sm:mt-24 max-w-7xl px-6 lg:px-8">
      ...
      {/* =========================
          Call To Action
      ========================= */}
      <div className="relative mt-24 sm:mt-28 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[28px] sm:rounded-[36px] bg-gradient-to-r from-emerald-600 via-green-600 to-emerald-700 shadow-2xl">
          <div className="relative px-6 py-12 sm:py-16 text-center lg:px-20">
            <div className="absolute -top-24 -left-24 h-64 w-64 rounded-full bg-white/10 blur-3xl" />
            <div className="absolute -bottom-24 -right-24 h-64 w-64 rounded-full bg-white/10 blur-3xl" />

            <div className="relative z-10">
              <h2 className="text-3xl sm:text-4xl font-extrabold text-white lg:text-5xl">
                Together We Can Create Lasting Change
              </h2>

              <p className="mx-auto mt-4 sm:mt-6 max-w-3xl text-sm sm:text-lg leading-6 sm:leading-8 text-emerald-50">
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row justify-center gap-4 sm:gap-5">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-3 rounded-full bg-white px-8 py-4 font-semibold text-emerald-700 transition hover:scale-105"
                >
                  <HandHelping size={20} />
                  Join as Volunteer
                </Link>
                ...
                <Link
                  href="/donate"
                  className="inline-flex items-center justify-center gap-3 rounded-full border border-white px-8 py-4 font-semibold text-white transition hover:bg-white hover:text-emerald-700"
                >
                  <Heart size={20} />
                  Donate Today
                  <ArrowRight size={18} />
